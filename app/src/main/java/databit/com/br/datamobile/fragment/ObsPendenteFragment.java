...
public class ObsPendenteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.content_obspendente_fragment, container, false);
        edtObs = (EditText) layout.findViewById(R.id.editObspendente);
        Toast.makeText(getActivity(), "Favor colocar referência,descrição e quantidade das Peças Pendentes", Toast.LENGTH_SHORT).show();
        btnGravarObs = (Button) layout.findViewById(R.id.btnGravarobspendente);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mListener.getOsSelecionada().getFechaok().equals(1)) {
                        mListener.getOsSelecionada().setObspendente(edtObs.getText().toString());
        ...
        if (mListener.getOsSelecionada().getObspendente() != null) {
            edtObs.setText(mListener.getOsSelecionada().getObspendente().toString());
        }
